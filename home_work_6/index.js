...
function stringToarray(str) {
    ...
    for (let i = 0; i < str.length; i++) {
        if (str[i] === " " || str[i] === "\n") {
            ...
            strArray.push(str.slice(0, i)); //добавляем в массив слово сначала до разделяющего символа
...
let deleteСharacters = (str, length) =>
...
let toUpperFirstSymbol = (str = "пустая строка") =>
...
//!!!надо было разобрать строку в camelCase 
